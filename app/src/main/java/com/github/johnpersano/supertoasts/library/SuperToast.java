...
public class SuperToast {
     ...
     * 
     * @see #setOnDismissListener(String, Parcelable, OnDismissListener)
     */
    ...
    protected View onCreateView(Context context, LayoutInflater layoutInflater, int type, XModuleResources modRes) {
        return layoutInflater.inflate(modRes.getLayout(R.layout.supertoast), null);
    }
    ...
    protected void onPrepareShow() {
        ...
        mView.setAlpha(mStyle.transparence);
        this.mTextView.setText(this.mStyle.message);
        if (this.mStyle.drawable != null) {
            this.mImageView.setImageDrawable(this.mStyle.drawable);
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(this.mStyle.iconSize,this.mStyle.iconSize);
            layoutParams.setMarginStart(BackgroundUtils.convertToDIP(18));
            layoutParams.leftMargin=BackgroundUtils.convertToDIP(18);
    ...
    public SuperToast setDrawable(Drawable drawable) {
        this.mStyle.drawable = drawable;
        return this;
    }

    public Drawable getDrawable() {
        return this.mStyle.drawable;
    }

    public SuperToast setIconSize(int iconSize) {
        this.mStyle.iconSize = iconSize;
        return this;
    }

    public int getIconSize() {
        return this.mStyle.iconSize;
    }


    public SuperToast setTransParence(float transParence) {
        this.mStyle.transparence = transParence;
        return this;
    }

    public float getTransParence() {
        return this.mStyle.transparence;
    }
    ...
    /**
     * Returns the {@link OnDismissListener}
     * of the SuperToast.
     *
    ...
    public static SuperToast create(@NonNull Context context, @NonNull String text,
                                    @Style.Duration int duration,XModuleResources modRes) {
        return new SuperToast(context,modRes)
                .setText(text)
     ...
     */
    public static SuperToast create(@NonNull Context context, @NonNull String text,
                                    @Style.Duration int duration, @NonNull Style style,XModuleResources modRes) {
        return new SuperToast(context, style,modRes)
                .setText(text)
                .setDuration(duration);
    }
}