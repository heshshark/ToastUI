...
public class SuperActivityToast extends SuperToast {
    ...
    protected View onCreateView(@NonNull Context context, LayoutInflater layoutInflater,
                                @Style.Type int type, XModuleResources modRes) {
    ...
    /**
     * Sets the {@link OnDismissListener}
    ...
    public static void onRestoreState(Context context, Bundle bundle,
                                      ListenerUtils listenerUtils,XModuleResources modRes) {
        ...
        for (Style style : styleList) {
            if (!style.isSuperActivityToast) new SuperToast(context, style,modRes).show();
                ...
                final SuperActivityToast superActivityToast = new SuperActivityToast(context, style,modRes);
                // This SuperActivityToast was most likely showing before the orientation change so ignore the show animation
     ...
     */
    public static SuperActivityToast create(@NonNull Context context,XModuleResources modRes) {
        return (SuperActivityToast) new SuperActivityToast(context,modRes);
    }
     ...
     * @return The newly created SuperActivityToast
     */
    public static SuperActivityToast create(@NonNull Context context, @NonNull Style style,XModuleResources modRes) {
        return (SuperActivityToast) new SuperActivityToast(context, style,modRes);
    }
     ...
     * @return The newly created SuperActivityToast
     */
    public static SuperActivityToast create(@NonNull Context context, @Style.Type int type,XModuleResources modRes) {
        return (SuperActivityToast) new SuperActivityToast(context, type,modRes);
    }
    ...
    public static SuperActivityToast create(@NonNull Context context, @NonNull Style style,
                                            @Style.Type int type,XModuleResources modRes) {
        return (SuperActivityToast) new SuperActivityToast(context, style, type,modRes);
    }
     ...
     */
    public static SuperActivityToast create(@NonNull Context context, @NonNull Style style,
                                            @Style.Type int type, @IdRes int viewGroup,XModuleResources modRes) {
        return (SuperActivityToast) new SuperActivityToast(context, style, type, viewGroup,modRes);
    }
     ...
     * @return The newly created SuperActivityToast
     */
    public static SuperActivityToast create(@NonNull Context context, @NonNull String text, @Style.Duration int duration,XModuleResources modRes) {
        return (SuperActivityToast) new SuperActivityToast(context,modRes)
                .setText(text)
    ...
    public static SuperActivityToast create(@NonNull Context context, @NonNull String text, @Style.Duration int duration,
                                            @NonNull Style style,XModuleResources modRes) {
        return (SuperActivityToast)  new SuperActivityToast(context, style,modRes)
                .setText(text)
                .setDuration(duration);
    }
     ...
     */
    public static SuperActivityToast create(@NonNull Context context, @NonNull String text, @Style.Duration int duration,
                                            @NonNull Style style, @IdRes int viewGroup,XModuleResources modRes) {
        return (SuperActivityToast)  new SuperActivityToast(context, style, Style.TYPE_STANDARD, viewGroup,modRes)
                .setText(text)
                .setDuration(duration);
    }
}
