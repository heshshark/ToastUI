...
/**
 * This class will store references to the various attributes of a {@link SuperToast}
 * or {@link SuperActivityToast}.
 */
...
public class Style implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeFloat(transparence);
        parcel.writeInt(iconSize);
    ...
    private Style(Parcel parcel) {
        ...
        this.transparence = parcel.readFloat();
